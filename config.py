...
class Config:
  ...
  if ENV:
    BOT_TOKEN = os.environ.get('5546355735:AAHrEc46TJkqhz8uOq_H30ca40ObHeOxz0A')
    APP_ID = os.environ.get('1372269701')
    API_HASH = os.environ.get('e3d7dc0a8e44289283b4bf99553bb545')
